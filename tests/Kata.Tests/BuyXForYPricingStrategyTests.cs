...
internal class BuyXForYPricingStrategyTests
{
    ...
    [TestCase(0, 2, 0, Description = "Empty basket")]
    ...
    [TestCase(1, 3, 130, Description = "three item bundle, 1 item")]
    [TestCase(2, 3, 130, Description = "three item bundle, 2 items")]
    [TestCase(3, 3, 135, Description = "three item bundle, 3 items")]
